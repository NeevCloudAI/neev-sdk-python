...
class SandboxFiles:
    ...
    def write(self, path: str, content: Union[str, bytes], cwd: Optional[str] = None) -> Dict[str, int]:
    ...
    def read(self, path: str, cwd: Optional[str] = None) -> bytes:
    ...
    def read_text(self, path: str, cwd: Optional[str] = None) -> str:
...
class AsyncSandboxFiles:
    ...
    async def write(self, path: str, content: Union[str, bytes], cwd: Optional[str] = None) -> Dict[str, int]:
    ...
    async def read(self, path: str, cwd: Optional[str] = None) -> bytes:
    ...
    async def read_text(self, path: str, cwd: Optional[str] = None) -> str:
