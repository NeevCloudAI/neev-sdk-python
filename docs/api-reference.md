...
| `update(id, params, org_id=None, project_id=None)` | `Agent` | In-place update of egress and/or cpu/memory (`resources`; defaults & bounds in [`SandboxResources`](./api-inventory.md#sandboxresources)). Rejects `{}` locally. |
